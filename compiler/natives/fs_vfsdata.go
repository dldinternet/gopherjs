...
var FS = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2018, 2, 16, 18, 20, 18, 599905637, time.UTC),
		},
		"/src": &vfsgen۰DirInfo{
			name:    "src",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 310537000, time.UTC),
		},
		...
		"/src/encoding/gob": &vfsgen۰DirInfo{
			name:    "gob",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 274825000, time.UTC),
		},
		...
		"/src/internal/poll": &vfsgen۰DirInfo{
			name:    "poll",
			modTime: time.Date(2018, 2, 16, 17, 51, 55, 743135388, time.UTC),
		},
		"/src/internal/poll/fd_poll_js.go": &vfsgen۰CompressedFileInfo{
			name:             "fd_poll_js.go",
			modTime:          time.Date(2018, 2, 16, 17, 51, 55, 743629136, time.UTC),
		...
		"/src/io": &vfsgen۰DirInfo{
			name:    "io",
			modTime: time.Date(2018, 2, 16, 18, 19, 57, 912054829, time.UTC),
		},
		"/src/io/io_test.go": &vfsgen۰CompressedFileInfo{
			name:             "io_test.go",
			modTime:          time.Date(2018, 2, 16, 18, 19, 57, 912213838, time.UTC),
		...
		"/src/reflect": &vfsgen۰DirInfo{
			name:    "reflect",
			modTime: time.Date(2018, 2, 16, 17, 51, 56, 106699900, time.UTC),
		},
		...
		"/src/reflect/reflect.go": &vfsgen۰CompressedFileInfo{
			name:             "reflect.go",
			modTime:          time.Date(2018, 2, 16, 17, 51, 56, 107239087, time.UTC),
		...
		"/src/reflect/reflect_test.go": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2018, 2, 16, 17, 51, 55, 955462666, time.UTC),
		...
		"/src/strings": &vfsgen۰DirInfo{
			name:    "strings",
			modTime: time.Date(2018, 2, 16, 18, 19, 57, 881229107, time.UTC),
		},
		"/src/strings/strings.go": &vfsgen۰CompressedFileInfo{
			name:             "strings.go",
			modTime:          time.Date(2018, 2, 16, 18, 19, 57, 881077686, time.UTC),
		...
		"/src/strings/strings_test.go": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2018, 2, 16, 18, 19, 57, 881381723, time.UTC),
